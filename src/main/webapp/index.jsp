...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(static/images/backgroundphoto.jpg);" data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2">Choose your Mobile Phone</h1>
                    ...
                    <div class="intro-text text-center text-md-left">
                        ...
                        <p>
                            <a href="shop" class="btn btn-sm btn-primary">Buy Now</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="static/images/ecosystem.jpeg" alt="Image placeholder"
